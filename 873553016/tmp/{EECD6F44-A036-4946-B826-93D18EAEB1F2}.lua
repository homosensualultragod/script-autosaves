...
local Character = Player.Character
	...
	framesk1 = makeframe(scrn, 0.5, UDim2.new(0.05, 0, 0.895, 0), UDim2.new(0.2, 0, 0.1, 0), skillcolorscheme)
	framesk2 = makeframe(scrn, 0.5, UDim2.new(0.255, 0, 0.895, 0), UDim2.new(0.2, 0, 0.1, 0), skillcolorscheme)
	framesk3 = makeframe(scrn, 0.5, UDim2.new(0.46, 0, 0.895, 0), UDim2.new(0.2, 0, 0.1, 0), skillcolorscheme)
	framesk4 = makeframe(scrn, 0.5, UDim2.new(.665, 0, 0.895, 0), UDim2.new(0.3, 0, 0.1, 0), skillcolorscheme)
	...
	if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Torso") ~= nil then
		...
		if blocked == false then
			...
			BlockEffect(BrickColor.new("Really red"), hit.CFrame, 5, 5, 5, 6, 6, 6, 0.08, 1)
	...
	for i = 0, 1, 0.1 do
		swait()
		RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0 - 0.1 * math.cos(sine / 20)) * angles(math.rad(0), math.rad(0), math.rad(91)), 0.3)
...
combo = function()
	...
	local con = RightArm.Touched:connect(function(hit)
		...
		Damagefunc(RightArm, hit, 10, 18, math.random(1, 5), "Normal", RootPart, 0.2, "rbxassetid://199149221", 0.6)
	end
	)
	local con2 = LeftArm.Touched:connect(function(hit)
		
		Damagefunc(LeftArm, hit, 10, 18, math.random(1, 5), "Normal", RootPart, 0.2, "rbxassetid://199149221", 0.6)
	end
)
	for i = 0, 1, 0.1 do
		swait()
		RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0 - 0.1 * math.cos(sine / 20)) * angles(math.rad(0), math.rad(0), math.rad(-90)), 0.3)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, NeckCF * angles(math.rad(10), math.rad(0), math.rad(90)), 0.3)
		RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5 - 0.1 * math.cos(sine / 15), 0) * angles(math.rad(0), math.rad(90), math.rad(120)), 0.3)
		LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5 - 0.1 * math.cos(sine / 15), 0) * angles(math.rad(0), math.rad(0), math.rad(-10)), 0.3)
		RH.C0 = clerp(RH.C0, cf(1, -1 + 0.1 * math.cos(sine / 20), 0) * RHCF * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
		LH.C0 = clerp(LH.C0, cf(-1, -1 + 0.1 * math.cos(sine / 20), 0.1) * LHCF * angles(math.rad(0), math.rad(20), math.rad(0)), 0.3)
		FakeHandleWeld.C0 = clerp(FakeHandleWeld.C0, CFrame.new(0, 0, 0) * angles(math.rad(60), math.rad(0), math.rad(0)), 0.3)
	...
	for i = 0, 1, 0.1 do
		...
		Torso.Neck.C0 = clerp(Torso.Neck.C0, NeckCF * angles(math.rad(10), math.rad(0), math.rad(-50)), 0.3)
		RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5 - 0.1 * math.cos(sine / 15), 0) * angles(math.rad(0), math.rad(90), math.rad(90)), 0.3)
		LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5 - 0.1 * math.cos(sine / 15), 0) * angles(math.rad(90), math.rad(0), math.rad(-10)), 0.3)
		RH.C0 = clerp(RH.C0, cf(1, -1 + 0.1 * math.cos(sine / 20), 0) * RHCF * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
		LH.C0 = clerp(LH.C0, cf(-1, -1 + 0.1 * math.cos(sine / 20), 0.1) * LHCF * angles(math.rad(0), math.rad(20), math.rad(0)), 0.3)
	...
	for i = 0, 1, 0.1 do
		swait()
		RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0 - 0.1 * math.cos(sine / 20)) * angles(math.rad(0), math.rad(0), math.rad(-120)), 0.3)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, NeckCF * angles(math.rad(10), math.rad(0), math.rad(-50)), 0.3)
		RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5 - 0.1 * math.cos(sine / 15), 0) * angles(math.rad(0), math.rad(-90), math.rad(90)), 0.3)
		LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5 - 0.1 * math.cos(sine / 15), 0) * angles(math.rad(90), math.rad(0), math.rad(-10)), 0.3)
		RH.C0 = clerp(RH.C0, cf(1, -1 + 0.1 * math.cos(sine / 20), 0) * RHCF * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
	...
	if attack == false and co1 <= cooldown1 and k == "z" then
		...
		if attack == false and co2/3 <= cooldown2 and k == "x" then
			...
			if attack == false and co3 <= cooldown3 and k == "c" then
				...
				if attack == false and co4 <= cooldown4 and ultimate == false and k == "v" then
					ultimate = true
	...
	if ultimate == false then
	text1.Text = "[Z] Drain"
	text2.Text = "[X] Teleport Beam"
	text3.Text = "[C] Roar"
	text4.Text = "[V] Rising Sun"
	end
end
