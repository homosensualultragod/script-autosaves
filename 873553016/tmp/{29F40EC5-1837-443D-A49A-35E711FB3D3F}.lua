...
local Character = Player.Character
	...
	splosion = CreatePart(m, Enum.Material.Plastic, 0, 1, "Really black", "Handle", Vector3.new(0.200000003, 0.200000003, 1.10801423))
	splosionweld = CreateWeld(m, Character["Right Arm"], splosion, CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1), CFrame.new(0.0606536865, 3.06880665, -0.053850174, 0.999730885, -0.0130999982, 0.0191449989, -0.0131285042, -0.999912977, 0.00136399036, 0.0191254634, -0.00161496829, -0.999815762))
...
ParticleEmitter = {Create = function(Parent, Color1, Color2, LightEmission, Size, Texture, Transparency, ZOffset, Accel, Drag, LockedToPart, VelocityInheritance, EmissionDirection, Enabled, LifeTime, Rate, Rotation, RotSpeed, Speed, VelocitySpread)
		...
		elseif Type == "Normal" then
				...
				elseif Type == "Up" then
					...
					game:GetService("Debris"):AddItem(vp, 0.5)
									...
									for i = 0,39,1 do
									Effects.Block.Create(BrickColor.new("Really red"), hit.Parent.Torso.CFrame * angles(0, 0, 0) * CFrame.new(0,0,0), 5, 5, 5, 2.5, 2.5, 2.5, 0.035)
								...
								elseif Type == "Grab" then
											...
											hit.Parent.Torso.CFrame = FakeHandle.CFrame
											swait(1)
											end
											end
											), hit.Parent.Torso)
	...
	for _,c in pairs(workspace:children()) do
		local hum = c:findFirstChild("Humanoid")
		if hum ~= nil then
			local asdd = Instance.new("NumberValue", hum)
			asdd.Name = "combo"
			local asdd = Instance.new("NumberValue", hum)
			asdd.Name = "slow"
		end
...
Break = {Create = function(brickcolor, cframe, x1, y1, z1)
	...
	local con = RightArm.Touched:connect(function(hit)
		Damagefunc(RightArm, hit, 7, 15, math.random(1, 5), "Normal", RootPart, 0.2, "rbxassetid://1089136667", 0.8)
		if hit.Parent.Name ~= "Effects" and hit.Parent.Name ~= Character.Name and hit.Parent.Name ~= "WeaponModel" then
		MagniDamage(Hitbox, 10, 5, 10, 0, "Normal")
		Character.HumanoidRootPart.CFrame = Character.HumanoidRootPart.CFrame*CFrame.new(0,0,-15)
		Effects.Ring.Create(BrickColor.new("Black"), RootPart.CFrame * angles(math.rad(90), 0, 0), 5, 5, 5, .5, 2.5, 1, 0.07)
		end
	end
	)
	for i = 0, 1, 0.1 do
	...
	local con = Hitbox.Touched:connect(function(hit)
		...
		--Damagefunc(Hitbox, hit, 7, 15, math.random(1, 5), "Normal", RootPart, 0.2, "rbxassetid://1089136667", 0.8)
	end
)
	for i = 0, 1, 0.1 do
		--Effects.Block.Create(BrickColor.new("Really red"), Torso.CFrame * angles(0, 0, 0) * CFrame.new(0,0,0), 5, 5, 5, 10, 10, 10, 0.07)
		swait()
		RootJoint.C0 = clerp(RootJoint.C0, CFrame.new(0, 0, 0) * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, CFrame.new(0, 1.53, 0.248) * angles(math.rad(30), math.rad(0), math.rad(0)), 0.3)
		RW.C0 = clerp(RW.C0, CFrame.new(1.5, 1.4, 0) * angles(math.rad(0), math.rad(0), math.rad(160)), 0.3)
		LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 1.4, 0) * angles(math.rad(0), math.rad(0), math.rad(-160)), 0.3)
		RH.C0 = clerp(RH.C0, CFrame.new(0.5, -2, 0) * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
		LH.C0 = clerp(LH.C0, CFrame.new(-0.5, -1.363, -0.417) * angles(math.rad(-10), math.rad(0), math.rad(0)), 0.3)
		FakeHandleWeld.C0 = clerp(FakeHandleWeld.C0, CFrame.new(0, 0, 0) * angles(math.rad(60), math.rad(30), math.rad(-60)), 0.3)
		Humanoid.Jump = true
		RootPart.Velocity = Vector3.new(0,35,0)
	end
	
	for i = 0, 1, 0.1 do
		--Effects.Block.Create(BrickColor.new("Really red"), Torso.CFrame * angles(0, 0, 0) * CFrame.new(0,0,0), 5, 5, 5, 10, 10, 10, 0.07)
		swait()
		RootJoint.C0 = clerp(RootJoint.C0, CFrame.new(0, 0, 0) * angles(math.rad(-90), math.rad(90), math.rad(0)), 0.3)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, CFrame.new(0, 1.5,0) * angles(math.rad(0), math.rad(-90), math.rad(0)), 0.3)
		RW.C0 = clerp(RW.C0, CFrame.new(2, 0.5, 0) * angles(math.rad(0), math.rad(0), math.rad(90)), 0.3)
	...
	MagniDamage(splosion, 20, 10, 15, 0, "slow")
	Effects.Cylinder.Create(BrickColor.new("Really red"), RightArm.CFrame * CFrame.new(0,-15,0) * angles(0, 0, 0) * CFrame.new(0,-1,0), 5, 15, 5, 7.5, 50, 7.5, 0.05)
	Effects.Wave.Create(BrickColor.new("Black"), RightArm.CFrame * angles(math.rad(0), 0, 0), 5, 1, 5, 0.2, 0.5, 0.2, 0.05)
	...
	local posible = true
	local con = Hitbox.Touched:connect(function(hit)
		if posible == true and hit.Parent.Name ~= "Effects" and hit.Parent.Name ~= "WeaponModel" and hit.Parent.Name ~= Character and hit.Parent.Name ~= "Workspace" then
		Damagefunc(Hitbox, hit, 5, 7, 0, "Grab", RootPart, 0.2, "rbxassetid://1089136667", 0.8)
		posible = false
		end
		if posible == false then
		Damagefunc(Hitbox, hit, 1, 4, 0, "Normal", RootPart, 0.2, "rbxassetid://1089136667", 0.8)
		end
	end
)
	for i = 0, 1, 0.1 do
	...
	for i = 0, 3, 0.1 do
		swait()
		Effects.Block.Create(BrickColor.new("Really black"), FakeHandle.CFrame, 46, 46, 46, 5, 5, 5, 0.3)
		PlayAnimationFromTable({CFrame.new(-0.00892008841, -0.0430538058, -0.194138944, 0.481576502, -0.0958696082, 0.871144831, -0.244872004, 0.939692378, 0.238780618, -0.841499925, -0.328310072, 0.429058075), CFrame.new(-0.019540526, 1.47107708, -0.184671223, 0.594002783, 0.0319824666, -0.803827167, -0.0492451973, 0.998781085, 0.00334861875, 0.802954376, 0.0375955552, 0.59485364), CFrame.new(1.44977772, 1.05570471, -0.579476237, -0.248055339, -0.684091806, 0.685920715, 0.938187659, -0.346077472, -0.00586999068, 0.241397351, 0.642066121, 0.727652669), CFrame.new(-1.00610232, 0.414793789, -0.808649838, 0.390035987, -0.254886776, -0.88481909, -0.920793831, -0.111371592, -0.373811543, -0.00326408446, 0.960535944, -0.278137147), CFrame.new(0.500006855, -1.99999928, -6.67572021e-06, 0.939693093, -1.34110451e-06, -0.342019081, 9.983778e-07, 1, -1.13248825e-06, 0.342018992, 7.74860382e-07, 0.939692974), CFrame.new(-0.848742545, -1.53879189, 0.340080202, 1.00000012, -1.43051147e-06, 5.96046448e-08, 3.42726707e-07, 0.275636345, 0.961261988, -1.37090683e-06, -0.961262047, 0.275636375)}, 0.3, false)
		FakeHandleWeld.C0 = clerp(FakeHandleWeld.C0, CFrame.new(0, asd, 0) * angles(math.rad(60), math.rad(0), math.rad(-90)), 0.1)
		asd = asd + 1
	end
	for i = 0, 3, 0.1 do
		swait()
		Effects.Block.Create(BrickColor.new("Black"), FakeHandle.CFrame, 46, 46, 46, 5, 5, 5, 0.3)
		PlayAnimationFromTable({CFrame.new(-0.00892008841, -0.0430538058, -0.194138944, 0.481576502, -0.0958696082, 0.871144831, -0.244872004, 0.939692378, 0.238780618, -0.841499925, -0.328310072, 0.429058075), CFrame.new(-0.019540526, 1.47107708, -0.184671223, 0.594002783, 0.0319824666, -0.803827167, -0.0492451973, 0.998781085, 0.00334861875, 0.802954376, 0.0375955552, 0.59485364), CFrame.new(1.44977772, 1.05570471, -0.579476237, -0.248055339, -0.684091806, 0.685920715, 0.938187659, -0.346077472, -0.00586999068, 0.241397351, 0.642066121, 0.727652669), CFrame.new(-1.00610232, 0.414793789, -0.808649838, 0.390035987, -0.254886776, -0.88481909, -0.920793831, -0.111371592, -0.373811543, -0.00326408446, 0.960535944, -0.278137147), CFrame.new(0.500006855, -1.99999928, -6.67572021e-06, 0.939693093, -1.34110451e-06, -0.342019081, 9.983778e-07, 1, -1.13248825e-06, 0.342018992, 7.74860382e-07, 0.939692974), CFrame.new(-0.848742545, -1.53879189, 0.340080202, 1.00000012, -1.43051147e-06, 5.96046448e-08, 3.42726707e-07, 0.275636345, 0.961261988, -1.37090683e-06, -0.961262047, 0.275636375)}, 0.3, false)
		FakeHandleWeld.C0 = clerp(FakeHandleWeld.C0, CFrame.new(0, asd, 0) * angles(math.rad(60), math.rad(0), math.rad(-90)), 0.1)
		asd = asd - 1
	end
...
local zupdate = true
	...
	for i = 0, 3, 0.05 do
		swait()
		MagniDamage(Hitbox, 10, 5, 10, 0, "Normal")
		Effects.Block.Create(BrickColor.new("Really black"), FakeHandle.CFrame * angles(0, 0, 0), 5, 5, 5, 15, 15, 15, 0.07)
		Effects.Block.Create(BrickColor.new("Really red"), FakeHandle.CFrame * angles(0, 0, 0), 5, 5, 5, 1, 30, 1, 0.07)
		Effects.Wave.Create(BrickColor.new("Black"), FakeHandle.CFrame * angles(math.rad(math.random(1,90)), math.rad(math.random(1,90)), math.rad(math.random(1,90))), 10, 0, 10, 0.2, 0, 0.2, 0.2)
		PlayAnimationFromTable({CFrame.new(0.0565546378, -0.0999990329, -0.367125988, 0.961260855, -0.0573087893, -0.269617409, 0, 0.978147745, -0.207911134, 0.275640815, 0.199856818, 0.940255046), CFrame.new(-0.113377631, 1.58891118, -0.22031498, 0.979420662, -0.132742718, 0.152035505, 0.0793425888, 0.945866108, 0.314709842, -0.185580641, -0.296170384, 0.936932743), CFrame.new(1.06543005, 0.449709594, -0.841737628, 0.954402268, 0.290145159, 0.0702303126, 0.00985579193, 0.204505116, -0.978815973, -0.298361093, 0.934876263, 0.192320511), CFrame.new(0.0129491575, 0.461974859, -0.712421119, 0.674041271, -0.727749646, -0.126684859, -0.125153482, 0.0565113388, -0.990526795, 0.728014529, 0.68351084, -0.0529894382), CFrame.new(0.491102874, -1.78353405, 0.747602224, 0.939692736, 0.128122747, -0.317115575, 0.0711097792, 0.833735287, 0.547566354, 0.334546119, -0.537094116, 0.774344087), CFrame.new(-0.566793799, -1.99725187, -0.257866234, 1.00000012, 0, 4.76837158e-07, -9.68575478e-08, 0.978147745, 0.207911164, -4.76837158e-07, -0.207911134, 0.978147745)}, 0.3, false)
		FakeHandleWeld.C0 = clerp(FakeHandleWeld.C0, CFrame.new(0, asd, 0) * angles(math.rad(hobb), math.rad(0), math.rad(-90)), 0.1)
	...
	for i = 0, 1 do
		...
		Effects.Ring.Create(BrickColor.new("Black"), RootPart.CFrame * angles(0, 0, 0), 5, 5, 5, 1, 1, 1, 0.07)
		for i = 0, 1, 0.05 do
			Effects.Wave.Create(BrickColor.new("Black"), FakeHandle.CFrame * angles(3.14, 0, 0), 12, 1, 12, 0.2, 0.1, 0.2, 0.07)
			Torso.Velocity = RootPart.CFrame.lookVector * -50
			PlayAnimationFromTable({CFrame.new(0.41534692, -1.34110451e-07, -0.386532724, 0.662618637, -0.0894249901, 0.743599176, -0.139172986, 0.960852683, 0.239568397, -0.735912681, -0.26223141, 0.624233425), CFrame.new(-0.0485539213, 1.53545654, -0.217515782, 0.758588254, 0.153950363, -0.633121729, -0.0520595983, 0.982900262, 0.176626489, 0.649487257, -0.101026714, 0.753631234), CFrame.new(1.45274282, 0.873826981, -0.949364126, 0.0823617354, -0.743233144, 0.663943648, 0.914199769, -0.208912551, -0.347267181, 0.396806657, 0.635578632, 0.662257135), CFrame.new(-0.909216046, 0.453060716, -0.592161536, 0.364558309, -0.79455018, -0.485579401, -0.703706682, 0.106431037, -0.702473879, 0.609831393, 0.597798049, -0.520329893), CFrame.new(0.843343794, -1.88252175, -0.308028162, 0.862017155, -0.230767742, -0.451301038, 0.14889662, 0.966355145, -0.209731787, 0.484516472, 0.113595188, 0.867375433), CFrame.new(-0.775360465, -2.25170565, 0.232322067, 0.955271602, 0.199518695, 0.218285561, -0.21956712, 0.972969413, 0.0715604872, -0.198107541, -0.116287977, 0.97325772)}, 0.3, false)
			FakeHandleWeld.C0 = clerp(FakeHandleWeld.C0, CFrame.new(0, 0, 0) * angles(math.rad(0), math.rad(hobb), math.rad(0)), 0.3)
			MagniDamage(Hitbox, 10, 5, 10, 150, "Fire")
		end
	end
	con:disconnect()
	attack = false
	...
	for i = 0, 9 do
		...
		for i = 0, 1, 0.05 do
			swait()
			MagniDamage(Hitbox, 30, 3, 3, 0, "Snare")
			Effects.Block.Create(BrickColor.new("Really red"), Torso.CFrame, 395, 395, 395, -.5,-.5,-.5, 0.2)
			Effects.Block.Create(BrickColor.new("Really black"), Torso.CFrame, 5,500,5, 1, 60, 1, 0.05)
	...
	if k == "z"  then
		...
		if attack == false and co1 <= cooldown1 then	
		zactive = true	
		cooldown1 = 0
		Driver()
		end
		...
		if attack == false and k == "x" and co2 <= cooldown2 then
			...
			if attack == false and k == "c" and co3 <= cooldown3 then
				...
				Effects.Block.Create(BrickColor.new("Really red"), Torso.CFrame * angles(0, 0, 0) * CFrame.new(0,-1,0), 5, 5, 5, 15,15,15, 0.035)
				MagniDamage(Torso, 10, 5, 10, 0, "Fire")
				swait(15)
				end		
				Clone()	
				for i = 0,6,1 do
	...
	if zactive == true then
	text1.Text = "[Z]\n Momentum"
	end	
	
	if zactive == false then
	text1.Text = "[Z]\n Blast"
	end
	...
	Effects.Block.Create(BrickColor.new("Black"), RightArm.CFrame * angles(0, 0, 0) * CFrame.new(0,-1,0), 5, 5, 5, 2.5, 2.5, 2.5, 0.07)
	Effects.Block.Create(BrickColor.new("Really red"), RightArm.CFrame * angles(0, 0, 0) * CFrame.new(0,-1,0), 5, 5, 5, 55, .15, .15, 0.5)
end
					...
					if Torsovelocity < 1 and hit ~= nil then
						...
						if 2 < Torsovelocity and hit ~= nil then
							...
							if attack == false then
								RootJoint.C0 = clerp(RootJoint.C0, CFrame.new(0, 0, 0) * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
								Torso.Neck.C0 = clerp(Torso.Neck.C0, CFrame.new(0, 1.5, 0) * angles(math.rad(-10), math.rad(0), math.rad(0)), 0.3)
								RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0, .4) * angles(math.rad(-30), math.rad(0), math.rad(10)), 0.3)
								LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0, .4) * angles(math.rad(-30), math.rad(0), math.rad(-10)), 0.3)
