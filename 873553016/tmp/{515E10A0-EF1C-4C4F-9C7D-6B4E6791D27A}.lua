...
Break = {Create = function(brickcolor, cframe, x1, y1, z1)
	...
	for i = 0, 1.5, 0.1 do
		...
		Humanoid.Jump = true
		RootPart.Velocity = Vector3.new(0,17,0)
	end
	...
	for i = 0,6,1 do
	MagniDamage(splosion, 20, 1, 3, 0, "Normal")
	Effects.Cylinder.Create(BrickColor.new("Really red"), RightArm.CFrame * CFrame.new(0,-15,0) * angles(0, 0, 0) * CFrame.new(0,-1,0), 5, 5, 5, 7.5, 50, 7.5, 0.05)
