...
workspace.Base.Size = Vector3.new(2048,1,2048)

local p = Instance.new("Part", workspace)
p.Size = Vector3.new(15,1,5)
p.CFrame = CFrame.new(char.Torso.CFrame.X+10, 1, char.Torso.CFrame.Z+15)
p.Anchored = true
...
ww.CFrame = CFrame.new(p.CFrame.X+x+2.5,y-2,p.CFrame.Z+z)
...
p2.CFrame = CFrame.new(char.Torso.CFrame.X+10, 1, char.Torso.CFrame.Z+21)
p2.Anchored = true
...
p3.CFrame = CFrame.new(char.Torso.CFrame.X+20, 1, char.Torso.CFrame.Z+22.5)
p3.Anchored = true
...
w3.CFrame = CFrame.new(p.Position.X-6, 7, p.Position.Z)
w3.Anchored = true
...
w32.CFrame = CFrame.new(p.Position.X-6, 7, p.Position.Z+6)
w32.Anchored = true
...
w2.CFrame = CFrame.new(p.Position.X+10, 2, p.Position.Z+17)
w2.Anchored = true
w2.CanCollide = false
...
b3.CFrame = CFrame.new(p.Position.X-15, 1, p.Position.Z)
b3.Anchored = true
...
if hit.Parent.Name == tycoonparent then
if cash >= cost then
cash = cash - cost
cost = cost*1.5
