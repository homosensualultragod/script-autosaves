...
if Character.Name ~= "ipupeh213" then

Color1 = BrickColor.new("Bright red")
Color2 = BrickColor.new("Bright yellow")
Color3E = BrickColor.new("Bright orange")
...
Color1 = BrickColor.new("Dark stone grey")
Color2 = BrickColor.new("Dark stone grey")
Color3E = BrickColor.new("Dark stone grey")	
Color4 = BrickColor.new("Dark stone grey")
	
potin = game.Lighting["Qeler' Hammer"].Hammer:Clone()
potin.Parent = modelzorz
local handlewld2=weld(prt1,potin.Handle,prt1,euler(0,0,0)*cf(0,-1.41,0))
prt1.Transparency = 1
prt2.Transparency = 1
prt9.Transparency = 1
prt10.Transparency = 1
prt12.Transparency = 1
end
...
potin2 = game.Lighting["Qeler' Hammer"].Bracelet:Clone()
potin2.Parent = modelzorz2
local handlewld2=weld(lprt1,potin2.Handle,lprt1,euler(0,-math.pi/2,0)*cf(0,0,0))
lprt1.Transparency = 1
lprt2.Transparency = 1
...
CF = prt9.CFrame * CFrame.Angles(math.rad(90),0,0)
WaveEffect(Color1,CF,1,1,1,0.2,0.8,0.2,0.2,2)
MagicWaveThing(Color1,CF,1,1,1,0.4,1,0.4,0.1)
...
if size==3 then
MagicRing(Color1,euler(0,1.57,0),1,1,1,1,1,1,0.1,2,prt10)
elseif size==2 then
MagicRing(Color2,euler(0,1.57,0),1,1,1,0.5,0.5,0.5,0.1,2,prt10)
end
end
if counter%5==0 then
if size==1 then
MagicBlock(Color1,prt10.CFrame,5,5,5,1,1,1,0.1,3,prt10)
elseif size==2 then
MagicBlock(Color1,prt10.CFrame,7,7,7,1,1,1,0.1,3,prt10)
elseif size==3 then
MagicBlock(Color1,prt10.CFrame,9,9,9,1,1,1,0.1,3,prt10)
else
MagicBlock(Color1,prt10.CFrame*CFrame.Angles(math.rad(math.random(-180,180)),math.rad(math.random(-180,180)),math.rad(math.random(-180,180))),size*3,size*3,size*3,1,1,1,0.1,3,prt10)
MagicRing(Color1,euler(0,1.57,0),1,1,1,size/3,size/3,size/3,0.1,2,prt10)
end
end
end
for i=0,1,0.1 do
...
Damagefunc(hit,3*size,5*size,math.random(10,20),"Target",400,1,2)
end),head)
end
end
end
...
MagicRing(Color2,Part.CFrame,1,1,1,0.16*size,0.16*size,0.16*size,0.02,1)
MagicCircle(Color1,Part.CFrame,1,1,1,.66*size,.66*size,.66*size,0.01,1)
for i=0,0.5,0.1 do
swait()
MagicBlock(Color1,Part.CFrame,5,5,5,1.4,1.4,1.4,0.05,1)
end
end),ef)
num=num+1
swait(5)
...
bg.maxTorque=vt(5000,5000,5000) 
bg.P=9000
bg.Parent=Torso
...
fireballd=false
coroutine.resume(coroutine.create(function()
local fireball=part(3,workspace,0,0.5,Color1,"Fireball",vt(0.5,0.5,0.5))
...
for i=0,1,0.05 do
swait(1)
MagicBlock(Color1,Part.CFrame,1,1,1,5,5,5,0.05,1)
if n==5 then
MagicRing(Color4,Part.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),10,10,10,0.5,0.5,0.5,0.03,1)
n=0
end
n=n+1
end
...
WaveEffect(Color1,CF,1,1,1,0.2,0.8,0.2,0.02,2)
MagicWaveThing(Color1,CF,1,1,1,0.4,1,0.4,0.01)
...
num=1
for i=0,6 do
MagicRing(Color1,ceef*euler(1.57,0,0),1,1,1,num,num,0.5,0.05,1)
num=num+0.5
swait(5)
end
end),CF)
...
bodvel.P=5000
bodvel.maxForce=vt(5000,5000,5000)
bodvel.Parent=RootPart
...
local laser=part(3,modelzorz,0,0.5,Color3E,"Effect",vt(0.6,0.2,0.6))
laser.Anchored=true
...
heat=heat+math.random(0,1)
so("http://www.roblox.com/asset/?id=2697431",prt9,0.3,0.5) 
MagicCircle(Color1,prt9.CFrame,1,1,1,1.5,1.5,1.5,0.05,2)
local rockt=part(1,workspace,0,1,BrickColor.new("Black"),"Rocket",vt(1,1,1))
rockt.CanCollide = true
local rocktmesh=part(1,rockt,0,0,Color1,"Rocket",vt(1,1,1))
if Character.Name ~= "ipupeh213" then
local rocktmsh=mesh("SpecialMesh",rocktmesh,"FileMesh","http://www.roblox.com/asset/?id=2251534",vt(0,0,0),vt(0.2,0.2,0.2))
else
local rocktmsh=mesh("SpecialMesh",rocktmesh,"FileMesh","http://www.roblox.com/asset/?id=36869983",vt(0,0,0),vt(1,1,1))	
rocktmsh.TextureId = "http://www.roblox.com/asset/?id=36893145"
rocktmsh.VertexColor = Vector3.new(0.25, 0.25, 0.25)
end
...
swait()
hit,pos=rayCast(Part.Position,Part.CFrame.lookVector,2,modelzorz)
if hit~=nil and hit.Parent ~= Character and hit.Name ~= "Rocket" and hit.Parent ~= modelzorz and hit.Parent ~= modelzorz2 and hit.Parent.ClassName ~= "Accessory" then
	print(hit.Parent)
Part:Remove()
Part2:Remove()
...
MagicBlock(Color1,cf(pos),1,1,1,2,2,2,0.05,1)
end
end
Part.Parent=nil
Part2.Parent=nil
