...
sound.SoundId = "rbxassetid://395878898"
sound.Playing = true
sound.Looped = true
local dist = Instance.new("FlangeSoundEffect",sound)
dist.Enabled = false
dist.Mix = 1
local dist2 = Instance.new("DistortionSoundEffect",sound)
dist2.Enabled = false
dist2.Level = 1
local dist3 = Instance.new("CompressorSoundEffect",sound)
dist3.Enabled = false
dist3.GainMakeup = 50
...
while true do
	...
	if torsovel < 1 then
		...
		char.Torso.Neck.C0 = clerp(char.Torso.Neck.C0, NeckCF * CFrame.Angles(math.rad(0), math.rad(-30), math.rad(-45)), 0.3)
		RW.C0 = clerp(RW.C0, CFrame.new(.75, 1, -.5) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(-90)), 0.3)
		...
		RW.C0 = clerp(RW.C0, CFrame.new(math.random(-70,70)/30,math.random(-70,70)/30,math.random(-70,70)/30) * CFrame.Angles(math.rad(math.random(-180,180)), math.rad(math.random(-180,180)), math.rad(math.random(-180,180))), 0.3)
		LW.C0 = clerp(LW.C0, CFrame.new(math.random(-70,70)/30,math.random(-70,70)/30,math.random(-70,70)/30) * CFrame.Angles(math.rad(math.random(-180,180)), math.rad(math.random(-180,180)), math.rad(-90)), 0.3)
		RH.C0 = clerp(RH.C0, CFrame.new(math.random(-70,70)/30,math.random(-70,70)/30,math.random(-70,70)/30) * RHCF * CFrame.Angles(math.rad(math.random(-180,180)), math.rad(math.random(-180,180)), math.rad(math.random(-180,180))), 0.3)
		LH.C0 = clerp(LH.C0, CFrame.new(math.random(-70,70)/30,math.random(-70,70)/30,math.random(-70,70)/30) * LHCF * CFrame.Angles(math.rad(math.random(-180,180)), math.rad(math.random(-180,180)), math.rad(math.random(-180,180))), 0.3)
